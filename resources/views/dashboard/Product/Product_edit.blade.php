...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <!-- End Page Header -->
        <form action="{{ route('tenant.Product.update', ['Product' => $Product->id]) }}" method="POST"
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <!-- Form -->
                                    <div class="mb-4">
                                        <label for="productNameLabel"
                                            class="form-label">{{ __('Arabic name') }}</label>
                                        <input type="text" class="form-control" name="name_ar" id="productNameLabel"
                                            placeholder="{{ __('Product name in arabic') }}"
                                            aria-label=" {{ __('Product name in arabic') }}"
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="form-group">
                                            <textarea name="desc" class="form-control" placeholder="{{ __('Description') }}" id="floatingTextarea2" rows="6">
                        {!! $Product->desc !!}
                        </textarea>
                                            @error('desc')
                                                <div class="alert alert-danger mt-2">{{ $message }}</div>
                                ...
                                <div class="col-sm-6">
                                    <!-- Form -->
                                    <div class="mb-4">
                                        <label for="weightLabel" class="form-label"> {{ __('Arabic description') }}
                                        </label>
                                        <div class="form-group">
                                            <textarea name="desc_ar" class="form-control" placeholder="{{ __('Arabic description') }}" id="floatingTextarea2"
                                                rows="6">
                                {{ $Product->desc_ar }}
                            </textarea>
                                            @error('desc_ar')
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="price" id="priceNameLabel"
                                        placeholder="0.00" aria-label="0.00" value="{{ $Product->price }}">
                                </div>
                                @error('price')
                                    <div class="alert alert-danger mt-2">{{ $message }}</div>
                                @enderror
                            ...
                            <label class="row form-check form-switch" for="availabilitySwitch1">
                                ...
                                <span class="col-4 col-sm-3 text-end">
                                    <input {{ $Product->active == 1 ? 'checked' : '' }} name="active" type="checkbox"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                ...
                                <input value="{{ $Product->qty }}" type="text" class="form-control" name="qty"
                                    id="ProductQty" placeholder="{{ __('The amount of product you wanna add') }}"
                                    aria-label="eg.1 , 5">
                            </div>
                            @error('qty')
                                <div class="alert alert-danger mt-2">{{ $message }}</div>
                            ...
                            <div class="mb-4">
                                ...
                                <input value="{{ $Product->availabe_qty }}" type="text" class="form-control"
                                    name="availabe_qty" id="ProductQty"
                            ...
                            <div class="mb-4">
                                ...
                                <!-- Select -->
                                <select name="category_id" id="select-beast" placeholder="{{ __('Select category') }}"
                                    autocomplete="off">
                                    <option value="{{ $Product->category_id }}">
                                        {{ LangDetail($Product->category->name, $Product->category->name_ar) }} </option>
                                    @foreach ($categories as $category)
                                        <option value="{{ $category->id }}">
                                            {{ LangDetail($category->name, $category->name_ar) }} </option>
                                    @endforeach
                                </select>
                                @error('category_id')
                                    <div class="alert alert-danger mt-2">{{ $message }}</div>
            ...
            <!-- End Row -->
            {{-- Start popUp add-Ons --}}
            @livewire('select-option-edit', ['product' => $Product])
            {{-- Start popUp add-Ons --}}
