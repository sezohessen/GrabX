                ...
                <li class="navbar-vertical-footer-list-item">
                  ...
                  <div class="dropdown dropup">
                    <button type="button" class="btn btn-ghost-secondary btn-icon rounded-circle" id="selectLanguageDropdown" data-bs-toggle="dropdown" aria-expanded="false" data-bs-dropdown-animation>
                      <img class="avatar avatar-xss avatar-circle" src="./global_assets/vendor/flag-icon-css/flags/1x1/us.svg" alt="United States Flag">
                    </button>
                       ...
                       <ul class="py-4 navi navi-hover">
                            ...
                            <li class="navi-item">
                                <a href="{{url('/lang/en')}}" class="navi-link @if (App::isLocale('en'))  active  @endif">
                                    <span class="mr-3 symbol symbol-20">
                                        <img src="{{ global_asset('media/svg/flags/226-united-states.svg') }}" alt=""/>
                                    </span>
                            ...
                            <li class="navi-item">
                                <a href="{{url('/lang/ar')}}" class="navi-link @if (App::isLocale('ar'))  active  @endif" href="{{url('/ar')}}">
                                    <span class="mr-3 symbol symbol-20">
                                        <img src="{{ global_asset('media/svg/flags/158-egypt.svg') }}" alt=""/>
                                    </span>
