                        ...
                        <div id="navbarVerticalMenuPagesMenu">
                            ...
                            <div class="nav-item">
                                ...
                                <div id="navbarVerticalMenuPagesEcommerceProductsMenu" class="nav-collapse collapse "
                                    ...
                                    <a class="nav-link " href="{{ route('tenant.Product.index') }}">{{ __('Products')
                                        }}</a>
                                    <a class="nav-link " href="{{ route('tenant.Product.create') }}">{{ __('Add
                                        Product') }}</a>
                                    <a class="nav-link " href="{{ route('tenant.PromoCode') }}">{{ __('Promo code')
                                        }}</a>
                                </div>
                                <!-- End Collapse -->
                                <!-- Collapse -->
                                <div class="nav-item">
                                    ...
                                    <div id="navbarVerticalMenuPagesEcommerceOrder" class="nav-collapse collapse "
                                        ...
                                        <a class="nav-link " href="{{ route('tenant.order.index') }}">{{ __('Show
                                            Orders') }}</a>
                                        <a class="nav-link " href="{{ route('tenant.order.pending') }}">{{ __('Pending
                                            Orders') }}</a>
                                    </div>
                                </div>
                                <!-- End Collapse -->
                                ...
                                <div class="nav-item">
                                    ...
                                    <div id="governorate" class="nav-collapse collapse " data-bs-parent="#governorate">
                                        <a class="nav-link " href="{{ route('tenant.Governorate') }}">{{
                                            __('Governorate') }}</a>
                                ...
                                <div class="nav-item">
                                    ...
                                    <div id="navbarVerticalMenuPagesEcommerceCustomersMenu"
                                        ...
                                        <a class="nav-link " href="./ecommerce-customer-details.html">@lang('Customer
                                            details')</a>
                                    </div>
                                </div>
                                <!-- End Collapse -->
